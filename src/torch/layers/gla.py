...
#
# 纯 CPU 版本的 GLA 层实现。
# 所有 Triton/CUDA 内核均替换为朴素 PyTorch 操作。
...
from src.torch.modules.layernorm import RMSNorm
from src.torch.modules.fused_norm_gate import FusedRMSNormGated
from src.torch.layers.utils import get_unpad_data, index_first_axis, pad_input
from src.torch.modules.convolution import ShortConvolution
from src.torch.ops.gla import chunk_gla, naive_recurrent_gla, fused_chunk_gla

__all__ = ['naive_recurrent_gla', 'chunk_gla', 'fused_chunk_gla', 'GatedLinearAttention']

# =============================================================================
# Activation functions (替代 fla.modules.activations.ACT2FN)
# =============================================================================
...
# fused_recurrent 直接映射到 naive (数学等价, 逐步递归)
fused_recurrent_gla = naive_recurrent_gla

# =============================================================================
# GatedLinearAttention 层 (CPU-only 版本)
# 完整复制自 fla/fla/layers/gla.py，所有 Triton 依赖替换为上述纯 PyTorch 实现
# =============================================================================
...
class GatedLinearAttention(nn.Module):
    ...
    纯 CPU 版本，所有 Triton 内核替换为朴素 PyTorch 递归实现。
